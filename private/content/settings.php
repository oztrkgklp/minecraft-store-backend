                      ...
                      <div class="row">
                        ...
                        <div class="col-auto">
                          <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="checkboxWebhookStoreAdStatus">Powered by RIVADEV yazısı gözüksün</label>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-auto">
                          <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="checkboxWebhookSupportAdStatus">Powered by RIVADEV yazısı gözüksün</label>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-auto">
                          <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="checkboxWebhookNewsAdStatus">Powered by RIVADEV yazısı gözüksün</label>
                          </div>
                        </div>
                      </div>
                    </div>
